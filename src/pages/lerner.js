...
{`
But while I, too, dislik him,
 I'm still here constructing a`} <Popup content="In Leaving the Atocha Station, the main character has won a Fullbright to Madrid in order to work on, 'A long, research based poem on the subject of the Spanish Civil War.'" trigger={<span>long, researched based poem on the subject of Ben Lerner.</span>} />  
{`
